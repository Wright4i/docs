...
Changing a filter definition is quick and easy. Just right click on the filter and choose **Change…** to open up the filter dialog. Or choose **Delete…** to remove the filter definition.

</Card><Card>

![Change filter](../../../assets/Browser_10.png)
